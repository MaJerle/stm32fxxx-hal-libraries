 ...
 */
typedef enum {
	TM_USBH_FS = 0x00, /*!< USB Full Speed mode */
	TM_USBH_HS = 0x01, /*!< USB High Speed mode */
	TM_USBH_Both       /*!< USB both modes */
} TM_USBH_t;
 ...
 * @param  USB_Mode: USB Mode to be initialized. This parameter can be a value of @ref TM_USBH_t enumeration
 ...
 * @param  USB_Mode: USB Mode to be started. This parameter can be a value of @ref TM_USBH_t enumeration
 * @retval Member of @ref TM_USBH_Result_t enumeration
 */
 ...
 * @param  USB_Mode: USB Mode to be restarted. This parameter can be a value of @ref TM_USBH_t enumeration
 * @retval Member of @ref TM_USBH_Result_t enumeration
 */
 ...
 * @param  USB_Mode: USB Mode to be processed. This parameter can be a value of @ref TM_USBH_t enumeration
 * @retval Member of @ref TM_USBH_Result_t enumeration
 */
 ...
 * @param  USB_Mode: USB Mode to be checked for connected device. This parameter can be a value of @ref TM_USBH_t enumeration
 * @retval Member of @ref TM_USBH_Result_t enumeration
 */
 ...
 * @param  USB_Mode: USB Mode where VID will be checked. This parameter can be a value of @ref TM_USBH_t enumeration
